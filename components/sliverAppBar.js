...
const propTypes = {
    ...
    imageBlurOpacity: PropTypes.string,
...
const defaultProps = {
    ...
    imageBlurOpacity: "rgba(0, 0, 0, 0.10)",
    isPin: false,
};
            ...
            <View style={styles.fill}>
                ...
                <Animated.View
                    style={[
                        styles.header,
                        {
                            backgroundColor: isPin ? Colors.whiteColor : 'transparent',//toolbarColor,
                            height: isPin ? toolbarMaxHeight + 50.0 : toolbarMaxHeight,
                    ...
                    <Animated.Image
                        style={[
                            styles.backgroundImage,
                            {
                                ...
                                transform: isPin ? [] : [{ translateY: imageTranslate }],
                            },
                        ]}
                        borderBottomLeftRadius={borderBottomRadius}
                        borderBottomRightRadius={borderBottomRadius}
                    ...
                    />
                    {
                        isImageBlur ?
                            <Animated.View style={[
                                ...
                                {
                                    height: toolbarMaxHeight,
                                    backgroundColor: imageBlurOpacity, //"rgba(0, 0, 0, 0.10)",
                                    borderBottomLeftRadius: borderBottomRadius,
                                    borderBottomRightRadius: borderBottomRadius,
                                },
                            ]}>
                ...
                <Animated.View
                    style={[
                        styles.bar,
                        {
                            transform: isPin ? [] : [{ scale: elementScale },],
                        },
                    ]}
                >
